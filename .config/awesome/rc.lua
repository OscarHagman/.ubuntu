...
-- (remove capitlized words with the desired ones, ie: KEY >> r to launch program with modkey + r)   
--awful.key({ modkey, "ADDITIONAL KEY" },            "KEY",     function ()
--    awful.util.spawn("PROGRAM") end,
